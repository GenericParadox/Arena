...
public class Timer : MonoBehaviour
{
	...
	TimerStoppedEvent timerStoppedEvent = new TimerStoppedEvent();

	TimerFinishedCoordEvent timerFinishedCoordEvent = new TimerFinishedCoordEvent();
    ...
    /// <summary>
    /// Gets how many seconds passed since timer started
    /// </summary>
    /// <value>seconds left</value>
	public TimeSpan ElapsedSeconds
	{
		get { return TimeSpan.FromSeconds((double)(new decimal(elapsedSeconds)));}
	}
    ...
    /// <summary>
    /// Adds the given listener to the timer finished event with coordinates for tile
    /// </summary>
    /// <param name="listener">listener</param>
    public void AddTimerFinishedCoordListener(UnityAction<int,int> listener)
    {
        timerFinishedCoordEvent.AddListener(listener);
    }
